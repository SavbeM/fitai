...
export function Navbar() {
    return (
        <header className="relative w-full bg-white text-sm">
            <nav className="mx-auto px-4 h-12 sm:flex sm:items-center sm:justify-between">
                <div className="flex items-center justify-between py-3">
                    <Link
                        ...
                        aria-label="Brand"
                    >
                        <Image width={200} height={80} src="/assets/logo_short.png" alt="Logo" />
                    </Link>

                    <div className="sm:hidden">
                        <button
                            type="button"
                            className="hs-collapse-toggle size-9 flex items-center justify-center rounded-lg border border-gray-200 bg-white text-gray-800 hover:bg-gray-50 focus:outline-hidden"
